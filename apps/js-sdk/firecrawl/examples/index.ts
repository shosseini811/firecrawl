...
export interface FirecrawlDocumentMetadata {
  ...
  // [key: string]: This indicates that the property name (key) can be any string
  // any: This indicates that the value can be of any type
  // This feature is particularly useful in scenarios like web scraping or API integrations where:

  // Unknown properties: You might encounter metadata fields that aren't predefined in your interface
  // Extensibility: Users of your library can add custom metadata properties
  // Future-proofing: New metadata standards might emerge that you want to support without updating the interface
}
...
export default class FirecrawlApp {
  // apiKey can be accessed and modified from outside the FirecrawlApp class.
